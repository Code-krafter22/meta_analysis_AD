...
This document evaluates whether a gene signature derived from the discovery/meta-analysis cohort generalizes to an independent external cohort (GSE125583).
